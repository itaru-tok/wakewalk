...
export default function CustomSwitch({ value, onValueChange, style }: CustomSwitchProps) {
  const translateX = useRef(new Animated.Value(value ? THUMB_TRAVEL_DISTANCE : 0)).current;
